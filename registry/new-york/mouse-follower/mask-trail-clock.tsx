/**
 * A cursor trail where each image sweeps in like a clock hand via a conic-gradient mask, then fades.
 */
"use client";
...
const MaskTrailClock = () => {
  ...
  useEffect(() => {
    ...
    const showNextImage = () => {
      ...
      gsap
        .timeline()
        .to(st, { p: 1, duration: 0.6, ease: "power2.out", onUpdate: apply }, 0)
        .to(el, { scale: 1, duration: 0.6, ease: "power2.out" }, 0)
