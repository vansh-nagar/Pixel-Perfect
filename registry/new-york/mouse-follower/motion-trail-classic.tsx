/**
 * A GSAP cursor trail where images appear at the cursor, glide to it, then scale and fade out.
 */
"use client";
  ...
  useEffect(() => {
    ...
    const showNextImage = () => {
      ...
      gsap
        ...
        .fromTo(
          el,
          { opacity: 1, scale: 1, zIndex: z, x: cache.x - SIZE / 2, y: cache.y - SIZE / 2 },
          { duration: 0.4, ease: "power1", x: mouse.x - SIZE / 2, y: mouse.y - SIZE / 2 },
          0
        )
        .to(el, { duration: 0.4, ease: "power3", opacity: 0, scale: 0.2 }, 0.4);
    };
...
export default MotionTrailClassic;
