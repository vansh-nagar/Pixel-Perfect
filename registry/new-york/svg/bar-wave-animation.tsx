...
const BarWaveAnimation = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[50vh] w-96">
      <svg
        className=" invert dark:invert-0 cursor-pointer w-full h-full"
        viewBox="0 0 350 130"
        overflow={"visible"}
      >
        <g transform="rotate(180, 175, 65)">
          {Array.from({ length: TOTAL }).map((_, i) => {
            ...
            const distance =
              hovered === null ? Infinity : Math.abs(hovered - i);
