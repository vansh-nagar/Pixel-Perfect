import FloatingTextCanvas from "@/components/mine/landing-page/canvas/floating-text-canvas";
  ...
  return (
    <div className="relative w-full grid min-h-screen grid-cols-[1fr_1rem_auto_1rem_1fr] grid-rows-[auto_1px_auto_1px_auto_1px_auto_1px_auto_1px_auto_1px_auto_1px_auto_1px] [--pattern-fg:var(--color-gray-950)]/5 dark:bg-black dark:[--pattern-fg:var(--color-white)]/10">
      ...
      <div className="col-start-3 row-start-5 py-6 relative overflow-hidden">
        <FloatingTextCanvas className="absolute inset-0 w-full h-full" />
        <StarBorder />
      </div>
      ...
      <div className="pointer-events-none  relative  col-span-full col-start-1 row-start-12 mask-x-from-99% border-b z-50 "></div>

      {/* Row 5: Socials Section */}
      <div className="col-start-3 row-start-13 flex flex-col w-[90vw]">
        <SocialProof />
      </div>

      <div className="pointer-events-none  relative  col-span-full col-start-1 row-start-14 mask-x-from-99% border-b z-50 "></div>
