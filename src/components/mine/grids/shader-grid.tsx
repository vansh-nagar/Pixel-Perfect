...
const ShaderGrid = () => {
  ...
  // Esc to close + lock scroll while the full-screen preview is open.
  useEffect(() => {
    if (!active) return;
        ...
        createPortal(
          ...
          >
            ...
            <button
              ...
              className="absolute right-5 top-5 z-10 flex size-10 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur transition-colors hover:bg-black/70"
            >
              <X className="size-5" />
            </button>
