...
/**
 * A 3D logo that draws itself in (SVG stroke), rises with an easeOutBack overshoot and floats, over a cursor-distorted pixel-text background, with a hover ink-bleed reveal and click "venom" takeover shader.
 */
...
export default FloatingLogoIntro;
