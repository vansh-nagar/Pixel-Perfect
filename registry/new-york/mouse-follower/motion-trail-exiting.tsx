/**
 * A GSAP cursor trail where each image pops in at the cursor, then exits upward with a random sideways drift.
 */
"use client";
  ...
  useEffect(() => {
    ...
    const showNextImage = () => {
      ...
      gsap
        ...
        .fromTo(inner, { scale: 1.2 }, { duration: 0.4, ease: "power1", scale: 1 }, 0)
        .to(
          el,
          {
            duration: 0.6,
...
export default MotionTrailExiting;
