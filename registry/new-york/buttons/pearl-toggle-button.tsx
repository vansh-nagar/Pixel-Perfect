...
const PearlToggleButton = () => {
  ...
  return (
    <button
      ...
      style={{
        background:
          "linear-gradient(180deg, #D4D4D8 0%, #E4E4E7 35%, #F4F4F5 70%, #FAFAFA 100%)",
        boxShadow: [
          "inset 0 0 0 1px rgba(120,120,130,0.35)",
    ...
    >
      <motion.span
        ...
        style={{
          background:
            "linear-gradient(135deg, #FFFFFF 0%, #F4F4F5 45%, #D4D4D8 100%)",
          boxShadow: [
            "inset 0 0 0 0.5px rgba(100,100,110,0.45)",
