...
const InfiniteImageScrollerPlane = () => {
  ...
  useEffect(() => {
    ...
    const meshCount = 60; // Reduced number of planes
    ...
    // Initialize planes in flat grid pattern - all at same depth
    ...
    for (let x = 0; x < gridSize; x++) {
      for (let y = 0; y < gridSize; y++) {
        ...
        planePositionsRef.current.push(
          new THREE.Vector3(dummy.position.x, dummy.position.y, 0)
        );
...
export default InfiniteImageScrollerPlane;
