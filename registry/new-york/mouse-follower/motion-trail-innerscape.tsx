/**
 * A GSAP cursor trail where the outer image grows in while its inner layer un-zooms from a bright over-scale.
 */
"use client";
  ...
  useEffect(() => {
    ...
    const showNextImage = () => {
      ...
      gsap
        ...
        .to(el, { duration: 0.4, ease: "power2", opacity: 0, scale: 0.2 }, 0.45);
    };
...
export default MotionTrailInnerscape;
