...
export type GlassSquareVariant =
  | "blue"
  | "purple"
  | "emerald"
  | "rose"
...
> = {
  blue: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(16, 191, 255, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  purple: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(168, 85, 247, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  emerald: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(16, 185, 129, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  rose: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(244, 63, 94, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  amber: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(245, 158, 11, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  cyan: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(6, 182, 212, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  lime: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(132, 204, 22, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  slate: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(100, 116, 139, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  red: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(239, 68, 68, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
  ...
  indigo: {
    border:
      "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(99, 102, 241, 0.6) 50%, rgba(255, 255, 255, 0.7) 100%)",
    inner:
...
interface GlassSquareButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: GlassSquareVariant;
}

const GlassSquareButton = React.forwardRef<
  HTMLButtonElement,
  GlassSquareButtonProps
>(({ className, children, variant = "blue", ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "relative inline-flex items-center justify-center px-6 py-4 text-sm font-medium text-white transition-transform duration-200 active:scale-[0.98]",
        className,
      )}
      style={{
        background: border,
    ...
    >
      ...
      />
      <span className="relative z-10">{children || "Glass"}</span>
    </button>
  );
});

GlassSquareButton.displayName = "GlassSquareButton";

export default GlassSquareButton;
