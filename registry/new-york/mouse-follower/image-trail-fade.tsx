/**
 * A GSAP cursor trail where images ease toward the cursor, then fade and shrink away.
 */
"use client";
  ...
  useEffect(() => {
    ...
    const showNextImage = () => {
      ...
      gsap
        ...
        .to(el, { duration: 0.9, ease: "expo", x: mouse.x - SIZE / 2, y: mouse.y - SIZE / 2 }, 0)
        .to(el, { duration: 1, ease: "power1", opacity: 0 }, 0.4)
        .to(el, { duration: 1, ease: "quint", scale: 0.2 }, 0.4);
    };
