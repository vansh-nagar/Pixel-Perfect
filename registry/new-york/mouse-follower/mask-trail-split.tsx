/**
 * A cursor trail where each image splits open from a centered seam via an animated clip-path inset, then fades.
 */
"use client";
    ...
    const showNextImage = () => {
      ...
      gsap
        ...
        .fromTo(
          ...
          { clipPath: "inset(0% 0% 0% 0% round 8px)", duration: 0.55, ease: "power4.inOut" },
          0
        )
        .to(el, { scale: 1, duration: 0.55, ease: "power4.inOut" }, 0)
