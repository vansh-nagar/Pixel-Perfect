...
/**
 * A row of image cards fanned along a 3D diagonal that recedes up-and-to-the-right; it auto-slides, loops infinitely with no seam, and can be dragged to scrub.
 */
