...
/**
 * A row of flat colour cards fanned along a 3D diagonal that recedes up-and-to-the-right; it auto-slides, loops infinitely with no seam, and can be dragged to scrub.
 */
...
const C = {
  persp: 2220, // CSS perspective distance (px)
  ox: 75, // perspective-origin X (% — vanishing point)
  oy: 12, // perspective-origin Y (%)
  sx: 219, // → right  per card
  sy: 98, //  ↑ up     per card
  sz: 210, // ← back   per card
  ry: 0, // card angle about Y (deck fan)
  rz: 0, // jaunty tilt
  posX: 0, // deck anchor X (% of container)
  posY: 100, // deck anchor Y (%)
  cw: 640, // card width (px)
  ch: 460, // card height (px)
};

const PerspectiveDeckCarousel = () => {
...
export default PerspectiveDeckCarousel;
