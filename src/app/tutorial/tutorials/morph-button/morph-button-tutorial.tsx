...
const MorphPreview = ({
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <MorphButton>Hover Me</MorphButton>
    ...
    <div className="flex flex-col gap-6 text-sm leading-relaxed">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          A black SVG <strong>path</strong> sits behind the text. Initially flat
          at the bottom, it morphs through a curved midpoint (the
          &quot;wave&quot; shape) and then fills the entire button. GSAP
          MorphSVG handles the smooth interpolation between path data strings.
        </p>
...
"M 0 100 V 0 Q 50 0 100 0 V 100 z"`}
        ...
        <p className="text-[10px] text-muted-foreground italic">
          Toggle off to see: without the morph, there is no visual fill effect
          on hover.
        </p>
      </div>
    ...
    ease: "power2.inOut",
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          ...
          adding a subtle &quot;pop&quot; that enhances the premium feel. Small
          details like this make animations feel much more polished.
        </p>
        <div className="border border-dashed p-3 bg-foreground/[0.02]">
          <pre className="text-[10px] text-muted-foreground font-mono whitespace-pre-wrap">
            {`tl2.to(".text", {
  ...
  ease: "power2.inOut",
      ...
      <div className="border border-dashed p-4">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[10px] text-muted-foreground">
          ...
          <span>&#8594;</span>
          <span
            className={`px-2 py-1 border border-dashed transition-colors ${showSvgPath ? "bg-green-500/10 text-green-600 border-green-500/30" : "bg-foreground/[0.03]"}`}
          >
            Path Morph
          </span>
          <span>&#8594;</span>
          <span
            className={`px-2 py-1 border border-dashed transition-colors ${showColorShift ? "bg-green-500/10 text-green-600 border-green-500/30" : "bg-foreground/[0.03]"}`}
          >
            Color Shift
          </span>
          <span>&#8594;</span>
          <span
            className={`px-2 py-1 border border-dashed transition-colors ${showScale ? "bg-green-500/10 text-green-600 border-green-500/30" : "bg-foreground/[0.03]"}`}
          >
            Scale
          </span>
          <span>&#8594;</span>
    ...
    <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 min-h-0 lg:min-h-[calc(100vh-120px)]">
      ...
      <div className="flex flex-col min-h-0 min-w-0">
        ...
        <div className="p-4 sm:p-6 flex-1">
          <MorphContent
            showSvgPath={showSvgPath}
            setShowSvgPath={setShowSvgPath}
            showColorShift={showColorShift}
            setShowColorShift={setShowColorShift}
            showScale={showScale}
