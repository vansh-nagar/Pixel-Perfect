...
const glassStyles: Record<
  GlassIconVariant,
  { border: string; inner: string; shadow: string; pill: string }
> = {
  blue: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(199, 240, 255, 0.55) 103.12%)",
  },
  purple: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(243, 232, 255, 0.55) 103.12%)",
  },
  emerald: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(209, 250, 229, 0.55) 103.12%)",
  },
  rose: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(255, 228, 230, 0.55) 103.12%)",
  },
  amber: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(254, 243, 199, 0.55) 103.12%)",
  },
  cyan: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(207, 250, 254, 0.55) 103.12%)",
  },
  lime: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(236, 252, 203, 0.55) 103.12%)",
  },
  slate: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(226, 232, 240, 0.55) 103.12%)",
  },
  red: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(254, 226, 226, 0.55) 103.12%)",
  },
  indigo: {
    border:
    ...
    pill: "linear-gradient(263.57deg, rgba(255,255,255,0.55) 10.17%, rgba(224, 231, 255, 0.55) 103.12%)",
  },
};
...
>(
  (
    ...
    const { border, inner, shadow, pill } = glassStyles[variant];
    return (
      <button
        ref={ref}
        className={cn(
          "relative inline-flex items-center gap-2 pl-5 pr-1.5 py-1.5 text-sm font-medium text-white transition-transform duration-200 active:scale-[0.98]",
          className,
        )}
        style={{
          background: border,
      ...
      >
        ...
        />
        <span className="relative z-10">{children || "Continue"}</span>
        <span
